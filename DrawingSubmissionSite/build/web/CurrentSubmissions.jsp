...
<jsp:root version="2.1" xmlns:f="http://java.sun.com/jsf/core" xmlns:h="http://java.sun.com/jsf/html" xmlns:jsp="http://java.sun.com/JSP/Page" xmlns:webuijsf="http://www.sun.com/webui/webuijsf">
    ...
    <f:view>
        <webuijsf:page id="CurrentSubmissions">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    ...
                    <div id="container" style="height: 262px">
                        ...
                        <div align="center" id="content" style="height: 120px">
                            This is where the drwings go!
                        </div>
                        <div align="center" id="rightBar" style="font-size: 18px; font-style: normal; height: 120px">Our Goal:
                            To provide a contest for children to express themselves through drawing.
                        </div>
